...
if WinActive("ahk_class Nobunaga Online Game MainFrame")
{
...
;MsgBox, 4, , Monitor top:%Mon1Top%, right: %Mon1Right%, bottom: %Mon1Bottom%, left: %Mon1Left%
;MsgBox, 4, , Monitor work top:%MonitorWorkAreaTop%, work right: %MonitorWorkAreaRight%, work bottom: %MonitorWorkAreaBottom%, work left: %MonitorWorkAreaLeft%
...
IsCombat()
{
	...
	if (ok:=FindText(1039-150000, 613-150000, 1039+150000, 613+150000, 0, 0, InCombatText)) {
		ret := true
	}
...
IsCombatEnd()
{
	;MsgBox IsCombatEnd
	ret := false
	;ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, %A_ScriptDir%\DELL_iscombatEnd.bmp
	if (ok:=FindText(573-150000, 539-150000, 573+150000, 539+150000, 0, 0, IsCombatEndText)) {
		ret := true
	}
	return ret
}
...
{
	ret := false
	;ImageSearch, FoundX, FoundY, 0,0, A_ScreenWidth, A_ScreenHeight, %A_ScriptDir%\DELL_standby.bmp
	if (ok:=FindText(573-150000, 539-150000, 573+150000, 539+150000, 0, 0, IsStandByText)) {
		ret := true
	}
...
if (ok:=FindText(1039-150000, 613-150000, 1039+150000, 613+150000, 0, 0, InCombatText)) {
	...
	Loop{
		Sleep 5000
		if (!FindText(573-150000, 539-150000, 573+150000, 539+150000, 0, 0, IsCombatEndText)) {
			;MsgBox OutCombat

			;press enter to enter into standby
			while (!FindText(573-150000, 539-150000, 573+150000, 539+150000, 0, 0, IsStandByText)) {
